      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
        <div className="bg-white rounded-t-3xl sm:rounded-2xl w-full max-w-xl shadow-2xl max-h-[90vh] sm:max-h-[85vh] flex flex-col">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <input
                  ...
                  placeholder="0"
                  className="flex-1 px-3 py-2 sm:px-4 sm:py-3 rounded-lg border border-gray-200 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all text-gray-900 font-medium text-sm sm:text-base"
                />
          ...
          <div className="flex items-center gap-2 sm:gap-3 p-4 sm:p-6 border-t border-gray-200 flex-shrink-0">
            <button
              onClick={handleClear}
              className="flex-1 px-4 py-2.5 sm:px-6 sm:py-3 rounded-lg border border-gray-200 text-gray-700 font-medium hover:bg-gray-50 transition-colors text-sm sm:text-base"
            >
              Clear
            </button>
            <button
              onClick={handleApply}
              className="flex-1 px-4 py-2.5 sm:px-6 sm:py-3 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors text-sm sm:text-base"
            >
              Apply Filters
            </button>
          </div>
