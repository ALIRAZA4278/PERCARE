...
export default function Features() {
  const features = [
    { icon: Stethoscope, title: 'Find Vets', description: 'Discover trusted veterinarians and clinics near you', color: 'blue' },
    { icon: ShoppingBag, title: 'Pet Shop', description: 'Quality pet products from verified sellers', color: 'green' },
    { icon: Heart, title: 'Shelters', description: 'Adopt, donate, and support animal welfare', color: 'red' },
    { icon: AlertTriangle, title: 'Lost & Found', description: 'Report lost pets or help reunite found animals', color: 'yellow' },
  ];
