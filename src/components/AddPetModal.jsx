  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-card rounded-2xl w-full max-w-2xl shadow-elevated max-h-[90vh] overflow-y-auto">
          <div className="flex items-center justify-between p-5 sm:p-6 border-b border-border sticky top-0 bg-card rounded-t-2xl z-10">
            <h2 className="text-lg font-bold text-foreground">Add New Pet</h2>
          ...
          <form onSubmit={handleSubmit} className="p-5 sm:p-6">
            ...
            <div className="mb-4">
              <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Pet Name *</label>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div>
                <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Species *</label>
              ...
              <div>
                <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Breed</label>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Age (Months)</label>
            ...
            <div className="mb-4">
              <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">Medical Notes</label>
            ...
            <div className="mb-6">
              ...
              {vaccines.length === 0 && (
                <p className="text-xs text-muted-foreground text-center py-3 border border-dashed border-border rounded-lg">No vaccines added yet</p>
              )}
              {vaccines.map((v, i) => (
                <div key={i} className="bg-muted rounded-lg p-3 mb-2 border border-border">
                  ...
                  <input type="text" placeholder="Vaccine name (e.g. Rabies)" value={v.vaccine_name}
                    ...
                    className="w-full px-3 py-2 rounded border border-border text-sm mb-2 outline-none focus:border-primary" />
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <input type="date" value={v.date_given}
                        ...
                        className="w-full px-3 py-2 rounded border border-border text-sm outline-none focus:border-primary" />
                    </div>
                    <div>
