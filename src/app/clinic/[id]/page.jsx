...
import { ArrowLeft, Star, MapPin, Heart, Shield, Phone, Globe, Clock, Stethoscope, Calendar } from 'lucide-react';
  ...
  if (!clinic) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center">
        <p className="text-xl font-bold text-foreground mb-4">Clinic not found</p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-4 sm:pt-6 pb-2">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-foreground">Clinic</h1>
          </div>
        ...
        <div className="flex gap-2 mb-5 overflow-hidden rounded-xl">
          {['🏥', '🩺'].map((emoji, i) => (
            <div key={i} className={`flex-1 h-36 sm:h-48 bg-muted flex items-center justify-center overflow-hidden rounded-xl`}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="bg-card rounded-2xl p-5 sm:p-6 border border-border mb-4">
          ...
          {clinic.is_emergency_available && (
            <div className="inline-flex items-center gap-1.5 bg-emergency/10 text-emergency text-xs font-semibold px-3 py-1.5 rounded-full border border-emergency/20">
              <Shield size={12} />
        ...
        {(clinic.phone || clinic.website || hours) && (
          <div className="bg-card rounded-2xl p-5 sm:p-6 border border-border mb-4">
            <h3 className="text-lg font-bold text-foreground mb-3">Contact & Hours</h3>
            <div className="space-y-2.5">
              ...
              {hours && (
                <div className="flex items-center gap-2.5 text-sm text-foreground">
                  <Clock size={15} className="text-muted-foreground" /><span>{hours}</span>
                </div>
              )}
            </div>
          </div>
