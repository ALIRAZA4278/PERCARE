...
export default function MarketplacePage() {
  ...
  const allProducts = [
    { id: 1, category: 'PETNUTRA', name: 'Premium Dog Food - Chicken', seller: 'PetCare by Saad', verified: true, rating: 4.8, reviews: 45, price: 2500, petType: 'Dog', categoryType: 'Food' },
    { id: 2, category: 'FURCARE', name: 'Cat Grooming Brush', seller: 'FurCare by Saad', verified: true, rating: 4.6, reviews: 32, price: 850, petType: 'Cat', categoryType: 'Grooming' },
    { id: 3, category: 'AVIHOME', name: 'Bird Cage - Large', seller: 'FurCare by Saad', verified: true, rating: 4.9, reviews: 18, price: 4200, petType: 'Bird', categoryType: 'Houses' },
    { id: 4, category: 'CLEANPAWS', name: 'Flea & Tick Shampoo', seller: 'PetCare Clinic Store', verified: true, rating: 4.5, reviews: 67, price: 650, petType: 'Dog', categoryType: 'Hygiene' },
    { id: 5, category: 'PLAYPET', name: 'Chew Toys Pack (5)', seller: 'FurCare by Saad', verified: true, rating: 4.7, reviews: 89, price: 1200, petType: 'Dog', categoryType: 'Toys' },
    { id: 6, category: 'PETNUTRA', name: 'Kitten Milk Replacer', seller: 'PetNutra Official', verified: true, rating: 4.4, reviews: 23, price: 950, petType: 'Cat', categoryType: 'Food' },
    { id: 7, category: 'PETSTYLE', name: 'Dog Collar - Leather', seller: 'PetCare by Saad', verified: true, rating: 4.8, reviews: 34, price: 1100, petType: 'Dog', categoryType: 'Collars' },
    { id: 8, category: 'COMFYPAWS', name: 'Cat Bed - Premium', seller: 'FurNutra Official', verified: true, rating: 4.8, reviews: 56, price: 3200, petType: 'Cat', categoryType: 'Beds' },
    { id: 9, category: 'PETESSENTIALS', name: 'Steel Feeding Bowl Set', seller: 'PetCare Clinic Store', verified: true, rating: 4.3, reviews: 41, price: 750, petType: 'Dog', categoryType: 'Bowls' },
    { id: 10, category: 'PETSTYLE', name: 'Dog Raincoat - Medium', seller: 'FurCare by Saad', verified: true, rating: 4.5, reviews: 29, price: 1800, petType: 'Dog', categoryType: 'Clothes' },
  ];
  ...
  const getFilteredProducts = () => {
    ...
    switch (filters.sortBy) {
      ...
      case 'Most Reviews': filtered.sort((a, b) => b.reviews - a.reviews); break;
      default: break;
    }
    return filtered;
  };
            ...
            >
              ...
              <div className="p-3 sm:p-4">
                ...
                <div className="flex items-center gap-1 mb-1.5 sm:mb-2">
                  ...
                  {product.verified && <BadgeCheck size={12} className="text-blue-600 flex-shrink-0" />}
                </div>
