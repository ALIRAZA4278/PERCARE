...
export default function ProductDetails() {
  ...
  const product = {
    ...
    seller: { name: 'PetNutra Official', verified: true, type: 'Company Store' },
    ...
    features: [
      { text: 'Real chicken first ingredient' }, { text: 'Rich in Omega-3 & 6' },
      { text: 'No artificial preservatives' }, { text: 'Supports healthy coat' }, { text: 'All breed sizes' },
    ],
    badges: [
      { icon: Truck, label: '2-3 Days' }, { icon: Shield, label: 'Verified' }, { icon: RotateCcw, label: 'Easy Return' },
    ],
  };

  const reviews = [
    { id: 1, author: 'Hamza Tariq', date: 'Mar 5, 2026', rating: 5, comment: 'My dog loves this food! Great quality and packaging.' },
    { id: 2, author: 'Ayesha Malik', date: 'Feb 20, 2026', rating: 4, comment: "Good food but a bit pricey. My dog's coat has improved though." },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10">
          ...
          <div>
            <p className="text-[10px] sm:text-xs font-semibold text-blue-600 mb-1.5 sm:mb-2 uppercase tracking-wide">{product.category}</p>
              ...
              <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {product.seller.verified && <BadgeCheck size={14} className="text-blue-600 flex-shrink-0" />}
                  </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <button
                onClick={() => { for (let i = 0; i < quantity; i++) addToCart(product); setQuantity(1); }}
            ...
            <div className="border-t border-gray-200 pt-5 sm:pt-6">
              <div className="flex items-center justify-between mb-4 sm:mb-5">
                ...
                <button className="text-blue-600 font-medium text-xs sm:text-sm hover:text-blue-700 transition-colors">Write a Review</button>
              </div>
                  ...
                  <div key={review.id} className="bg-gray-50 rounded-xl p-4 sm:p-5 border border-gray-100">
                    <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                      <div className="w-9 h-9 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                        <span className="text-blue-600 font-semibold text-xs sm:text-sm">{review.author.charAt(0)}</span>
                      </div>
                      <div>
