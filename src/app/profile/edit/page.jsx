        ...
        <form onSubmit={handleSubmit}>
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <label className="absolute -bottom-1 -right-1 w-8 h-8 bg-primary rounded-full flex items-center justify-center border-2 border-white shadow-card cursor-pointer hover:bg-primary/90 transition-colors">
                <Camera size={14} className="text-white" />
                <input type="file" accept="image/*" onChange={handleAvatarUpload} className="hidden" />
              </label>
              {uploading && <div className="absolute inset-0 bg-card/70 rounded-full flex items-center justify-center text-xs text-muted-foreground">...</div>}
            </div>
          </div>
          ...
          <button type="submit" disabled={saving}
            className="w-full bg-primary hover:bg-primary/90 disabled:bg-primary/60 text-white font-semibold py-3.5 rounded-lg transition-colors shadow-card mt-6 text-sm">
