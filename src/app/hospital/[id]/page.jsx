  ...
  if (!clinic) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        <p className="text-lg font-bold text-foreground mb-2">Hospital not found</p>
    ...
    <div className="min-h-screen">
      <div className="sticky top-0 z-40 bg-background/80 backdrop-blur-xl border-b border-border">
        <div className="px-4 md:px-8 py-4 flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-foreground flex-1">Hospital</h1>
          <button
      ...
      <div className="px-4 md:px-8 py-6 max-w-2xl space-y-4">
        ...
        <div className="p-6 rounded-2xl bg-card shadow-card">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-14 h-14 rounded-2xl bg-emergency/10 flex items-center justify-center shrink-0">
              <Building2 className="h-6 w-6 text-emergency" />
            </div>
            <div className="min-w-0">
              <div className="flex items-center gap-1.5">
                <h2 className="text-lg font-bold text-foreground">{clinic.name}</h2>
                {clinic.is_approved && <Shield className="h-4 w-4 text-primary shrink-0" />}
              </div>
