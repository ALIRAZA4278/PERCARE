        ...
        {vets.length > 0 && (
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-gray-200 mb-4">
            ...
            <div className="space-y-2">
              {vets.map((vet) => (
                <Link key={vet.id} href={`/vet/${vet.id}`} className="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:bg-gray-50 transition-colors group">
