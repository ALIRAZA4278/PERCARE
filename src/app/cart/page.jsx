      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        {cartItems.length === 0 ? (
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-8 sm:p-16 text-center border border-gray-200">
            ...
            <Link
              href="/marketplace"
              className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg transition-colors text-sm sm:text-base"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-2 space-y-3 sm:space-y-4">
              {cartItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200 hover:shadow-md transition-shadow"
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-3 sm:mt-4 gap-3 sm:gap-0">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 bg-gray-100 rounded-lg px-2.5 sm:px-3 py-1.5 sm:py-2">
                          ...
                          <span className="font-semibold text-gray-900 w-7 sm:w-8 text-center text-sm sm:text-base">
                            {item.quantity}
                          </span>
                          <button
                            onClick={() => updateQuantity(item.id, item.quantity + 1)}
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
                  ...
                  <input
                    ...
                    className="flex-1 px-3 py-2 sm:px-0 sm:py-0 border sm:border-0 rounded-lg sm:rounded-none outline-none text-gray-900 text-sm sm:text-base"
                  />
                  <button className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-5 py-2.5 sm:px-6 sm:py-2 rounded-lg transition-colors text-sm sm:text-base">
                    Apply
                  </button>
                </div>
              </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200 lg:sticky lg:top-24">
                ...
                <button 
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-3 sm:px-6 sm:py-4 rounded-lg transition-colors mb-3 sm:mb-4 shadow-sm text-sm sm:text-base"
                >
                  Proceed to Checkout
                </button>
                ...
                <Link
                  href="/marketplace"
                  className="block text-center text-blue-600 font-medium hover:text-blue-700 transition-colors text-sm sm:text-base"
                >
                  Continue Shopping
                </Link>
                ...
                <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 space-y-2 sm:space-y-3">
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <p className="text-xs sm:text-sm text-gray-700">Free delivery on all orders</p>
                  </div>
                  <div className="flex items-start gap-2 sm:gap-3">
                    <div className="w-4 h-4 sm:w-5 sm:h-5 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-green-600 text-xs">✓</span>
                    </div>
                    <p className="text-xs sm:text-sm text-gray-700">100% buyer protection</p>
                  </div>
                  <div className="flex items-start gap-2 sm:gap-3">
                    <div className="w-4 h-4 sm:w-5 sm:h-5 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-green-600 text-xs">✓</span>
                    </div>
                    <p className="text-xs sm:text-sm text-gray-700">Easy returns within 7 days</p>
                  </div>
                </div>
              </div>
            </div>
