  ...
  if (needsConfirmation) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-lg text-center bg-card rounded-2xl border border-border p-8">
      ...
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-2xl border border-border p-6 sm:p-8">
          ...
          <p className="text-center text-sm text-muted-foreground mt-5">
            ...
            <Link href="/login" className="text-primary font-semibold hover:text-primary transition-colors">Sign in</Link>
          </p>
        </form>
      </div>
    </div>
