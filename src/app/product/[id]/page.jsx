  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
        ...
        <Link href="/shop" className="text-blue-600 hover:underline">Back to Marketplace</Link>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10">
          ...
          <div>
            ...
            {product.store && (
              <Link href={`/store/${product.store.id}`} className="bg-gray-50 rounded-xl p-3 sm:p-4 mb-5 sm:mb-6 flex items-center justify-between group cursor-pointer hover:bg-gray-100 transition-colors border border-gray-100">
