...
const iconMap = {
  ...
  vaccine_reminder: { icon: Syringe, iconBg: 'bg-amber/10', iconColor: 'text-amber', borderColor: 'border-amber/20' },
  order: { icon: Package, iconBg: 'bg-vitality/10', iconColor: 'text-vitality', borderColor: 'border-vitality/20' },
  review: { icon: CheckCircle, iconBg: 'bg-amber/10', iconColor: 'text-amber', borderColor: 'border-amber/20' },
  system: { icon: Bell, iconBg: 'bg-muted', iconColor: 'text-muted-foreground', borderColor: 'border-border' },
  approval: { icon: CheckCircle, iconBg: 'bg-vitality/10', iconColor: 'text-vitality', borderColor: 'border-vitality/20' },
};
