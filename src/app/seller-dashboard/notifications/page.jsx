...
const iconMap = {
  ...
  review: { icon: Star, iconBg: 'bg-yellow-50', iconColor: 'text-yellow-600', borderColor: 'border-yellow-200' },
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Stay updated on your store activity</p>
        </div>
        {unreadCount > 0 && (
          <button onClick={markAllRead} className="text-orange-600 font-medium text-sm hover:text-orange-700">Mark all read</button>
        )}
      </div>
