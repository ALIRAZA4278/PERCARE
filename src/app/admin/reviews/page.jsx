        ...
        <div className="flex gap-2 overflow-x-auto pb-1">
          {TARGET_TYPES.map(t => (
            <button key={t} onClick={() => setTargetFilter(t)}
              className={`px-3 py-2 rounded-lg text-xs font-semibold capitalize whitespace-nowrap flex items-center gap-1.5 transition-colors ${targetFilter === t ? 'bg-blue-600 text-white' : 'bg-white text-gray-500 border border-gray-200 hover:border-gray-300'}`}>
