...
export default function VetSettingsPage() {
  ...
  const settingsItems = [
    ...
    },
    {
      ...
      type: 'link', iconBg: 'bg-blue-50', iconColor: 'text-blue-600',
    },
    {
      icon: HelpCircle, label: 'Help & Support', description: 'FAQs and contact',
      type: 'link', iconBg: 'bg-purple-50', iconColor: 'text-purple-600',
    },
    {
      icon: Info, label: 'About PetCare', description: 'Version 1.0.0',
      type: 'link', iconBg: 'bg-gray-100', iconColor: 'text-gray-600',
    },
  ];
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/vet-dashboard" className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
      ...
      <div className="max-w-3xl">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-200 mt-4">
          <button onClick={handleLogout}
            className="flex items-center gap-3 sm:gap-4 p-4 sm:p-5 w-full hover:bg-red-50 transition-colors rounded-xl sm:rounded-2xl">
            <div className="w-10 h-10 sm:w-11 sm:h-11 bg-red-50 rounded-full flex items-center justify-center flex-shrink-0">
              <LogOut size={18} className="text-red-500" />
            </div>
            <div className="text-left">
              <p className="font-semibold text-red-600 text-sm sm:text-base">Log Out</p>
